...
public class KafkaConnection {
    ...
    Producer<String, PriceFeed> producer = null;
    static final String topicName = "priceFeed";

    public Producer<String, PriceFeed> getProducer() {
        if (producer == null) {
            createProducer();
        }
        return producer;
    ...
    private synchronized void createProducer() {
        ...
        if (producer == null) {
            ...
            try {
                ...
                props.put("value.serializer", "org.kafka.persistence.PriceFeedSerializer");
                producer = new KafkaProducer<String, PriceFeed>(props);
